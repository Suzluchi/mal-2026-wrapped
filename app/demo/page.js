...
export default function Demo() {
 ...
 return <><SiteHeader/><main id="main-content" className="lists-page demo-page"><div className="reader-title"><div><p className="eyebrow">A LOOK INSIDE</p><h1>The sample issue.</h1></div><p className="sample-label">FICTIONAL TITLES & DATA<br/>Original sample artwork. Not your MAL account.</p></div><div className="sample-toolbar"><label>Edition <select value={period} onChange={e=>setPeriod(e.target.value==='all'?'all':2026)}><option value="2026">2026</option><option value="all">All time</option></select></label><span>Tap through the reveals, or swipe between cards.</span></div><PersonalRecap key={period} anime={anime} manga={manga} period={period} asOf="2026-09-19" name="Sample reader"/></main><SiteFooter/></>;
}
